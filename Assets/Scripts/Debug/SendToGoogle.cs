...
public class SendToGoogle : MonoBehaviour
{
    ...
    void rellenarFormulario()
    {
        ...
        form.AddField("entry.794890710",  0);        // PlanetaSagradoP1
        form.AddField("entry.1157758824", 0);        // PlanetaSagradoP2
        form.AddField("entry.978047630",  0);        // scorePlanetaSagradoP1
        form.AddField("entry.1821666122", 0);        // scorePlanetaSagradoP2
